...
{
    $recipient="pageturners@gmail.com";
    ...
    $note="\n\nNote : This is an auto-generated mail do not reply to this.\nFrom:https://localhost/PageTurners/index.php";
    $resBody=$resBody . $note;
    mail($senderEmail , $resSub , $resBody);   
    header("location: bookstore.php?response="."Your Message has been successfully sent! Our customer executive would respond shortly."); 
}
?>	