...
if(!isset($_SESSION['user']))
       header("location: bookstore.php?Message=Login To Continue");
?>
    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="bookstore.php"><img alt="Brand" src="img/LOGO.jpg" style="width:147px;margin-top:-8%;height:47px;"></a>
        </div>
          ...
          <ul class="nav navbar-nav navbar-right">
              <?php
                  if(isset($_SESSION['user']))
                    {
                      echo'
                    <li><a href="cart.php" class="btn btn-md"><span class="glyphicon glyphicon-shopping-cart" style="color:black;"> Cart</span></a></li>
                    <li><a href="destroy.php" class="btn btn-md"> <span class="glyphicon glyphicon-log-out" style="color:black;"> LogOut</span></a></li>
                         ';
                    }
               ?>
          </ul>
...
<div class="container-fluid" id="service">
      <div class="row">
          <div class="col-sm-6 col-md-3 text-center">
               <span class="glyphicon glyphicon-heart" style="color:#009CCD;"></span> <br>
               24X7 Care <br>
               Happy to help 24X7, call us on 0120-3062244 or click here
          </div>
          <div class="col-sm-6 col-md-3 text-center">
               <span class="glyphicon glyphicon-ok" style="color:#009CCD;"></span> <br>
               Trust <br>
               Your money is yours! All refunds come with no question asked guarantee.
          </div>
          <div class="col-sm-6 col-md-3 text-center">
               <span class="glyphicon glyphicon-check" style="color:#009CCD;"></span> <br>
               Assurance <br>
               We provide 100% assurance. If you have any issue, your money is immediately refunded. Sit back and enjoy your shopping.
          </div>
          <div class="col-sm-6 col-md-3 text-center">
               <span class="glyphicon glyphicon-tags" style="color:#009CCD;"></span> <br>
               24X7 Care <br>
