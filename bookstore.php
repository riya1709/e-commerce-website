...
<head>
    ...
    <style>
      .modal-header {background:linear-gradient(to left, #e52d27, #b31217);color:#fff;font-weight:800;}
      .modal-body{font-weight:800;}
      .modal-body ul{list-style:none;}
      .modal .btn {background:linear-gradient(to left, #e52d27, #b31217);color:#fff;}
      .modal a{background: linear-gradient(to bottom, #ff0084, #33001b);}
      .modal-backdrop {position:inherit !important;}
       #login_button,#register_button{background:none;color:black!important;font-style:bold;}       
       #query_button {position:fixed;right:67%;bottom:0px;padding:10px 80px;
                      background:linear-gradient(to left, #e52d27, #b31217);color:#fff;border-color:#f05f40;border-radius:2px;}
  ...
  <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#" style="padding: 1px;"><img class="img-responsive" alt="Brand" src="img/LOGO.jpg"  style="width: 147px;margin:0px; height:47px;"></a>
        </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                          <form class="form" role="form" method="post" action="bookstore.php" accept-charset="UTF-8">
      ...
      <div class="container-fluid" id="header">
          <div class="row">
              <div class="col-md-3 col-lg-3" id="category">
                  <div style="  background: linear-gradient(to left, #e52d27, #b31217);color:#fff;font-weight:800;border:none;padding:15px;"> The Book Shop </div>
                  <ul>
